defmodule RigInboundGatewayWeb.V1.MetadataControllerTest do
  ...
  describe "Extract metadata:" do
    test " from JWT" do
      ...
      {:ok, jwt_values} = Metadata.extract_metadata_from_jwt(auth_tokens)
    ...
    test " from JSON" do
      ...
      {:ok,json_values} = Metadata.extract_metadata_from_json(json)
  ...
  describe "Fail extract metadata:" do
    test " from JWT" do
      ...
      {err, jwt_values} = Metadata.extract_metadata_from_jwt(auth_tokens)
      assert err === :error
      assert jwt_values === %{}
    end
    ...
    test " from JSON" do
      ...
      {err, json_values} = Metadata.extract_metadata_from_json(json)
      assert err === :error
