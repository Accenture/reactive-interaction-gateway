defmodule RigInboundGateway.Transports.ServerSentEvents.Encoder do
  ...
  defp format_data(%Phoenix.Socket.Message{event: "phx_reply"} = msg),
    do: "data: #{msg |> Poison.encode!()}\n"

  defp format_data(%Phoenix.Socket.Message{payload: nil}), do: "data:\n"

  defp format_data(%Phoenix.Socket.Message{payload: payload}),
    do: "data: #{payload |> Poison.encode!()}\n"
end
