defmodule RigOutboundGateway.Firehose.GroupSubscriber do
  @moduledoc """
  ...
  alias RigOutboundGateway.Firehose.MessageHandler
  ...
  def init(_consumer_group_id, :no_args) do
    ...
    handlers = spawn_message_handlers(conf.brod_client_id, conf.source_topics, conf.targets)
  ...
  @spec spawn_message_handlers(atom, nonempty_list(String.t()), nonempty_list(String.t())) :: handlers_t
  defp spawn_message_handlers(brod_client_id, [topic | remaining_topics], targets) do
    ...
    |> Map.merge(spawn_message_handlers(brod_client_id, remaining_topics, targets))
  end

  defp spawn_message_handlers(_brod_client_id, [], _targets) do
    %{}
  end
end
