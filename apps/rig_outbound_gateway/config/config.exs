...
config :rig, RigOutboundGateway.Kafka.Readiness, brod_client_id: brod_client_id
...
config :rig, RigOutboundGateway.Firehose.Readiness, brod_client_id: firehose_brod_client_id
