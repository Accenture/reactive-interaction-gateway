defmodule Rig.CloudEventOld do
  @moduledoc false
  @typedoc """
  CloudEvents v0.1
  ...
  @enforce_keys ~w(event_type source event_id)a
  ...
  defimpl String.Chars do
    alias Rig.CloudEventOld, as: CloudEvent

    def to_string(%CloudEvent{} = event) do
      age =
  ...
  def with_data(%__MODULE__{} = event, data) do
