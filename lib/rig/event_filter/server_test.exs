defmodule Rig.EventFilter.ServerTest do
  ...
  test "subscribe & receive an event" do
    ...
    EventFilter.forward_event(event, "eventhub_type", "topic")
    EventFilter.forward_event(event, "eventhub_type", "topic")
  ...
  test "Allows refreshing the field config" do
    ...
    EventFilter.forward_event(greeting_to_sam, "eventhub_type", "topic")
    ...
    EventFilter.forward_event(greeting_to_joe, "eventhub_type", "topic")
