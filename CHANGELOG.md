...
- Added validation for reverse proxy configuration. Now it crashes RIG on start when configuration is not valid or return `400` when using REST API to modify APIs in reverse proxy. [#277](https://github.com/Accenture/reactive-interaction-gateway/issues/277)
