...
`KINESIS_ENABLED` | If enabled, RIG will consume messages from a Amazon Kinesis using the configured broker and topic(s). Credentials are expected at `~/.aws/credentials`. | false
